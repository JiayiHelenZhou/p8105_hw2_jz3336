...
The first pols_moth.csv dataset contain information about national politicians. To clean up the data set, I separate the "mon" variable into "year","month"and day". Then I create a month tibble and left_joint it to the pols_month. By doing this, all numeric month will be convert to character month in the full name. After clean up the data set and rename it to pols_month_tidy, the dimension of the cleaned data is [`r dim(pols_month_tidy)`], where `r nrow(pols_month_tidy)` is the number of rows and `r ncol(pols_month_tidy)` is the number of columns. The "president" variable is created to contain democratic (dem) or republican (gop) at any given time. The year range of this data set is `r range(pull(pols_month_tidy, year))`.
