...
The final_df is created by merging all three datasets by "year" and "month_name". The dimension of the final_df is [`r dim(final_df)`], where `r nrow(final_df)` is the number of rows and `r ncol(final_df)` is the number of columns. The year range of this data set is `r range(pull(final_df, year))`.
