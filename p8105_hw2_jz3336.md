...
politicians. After clean up the data set and rename it to
pols\_month\_tidy, the dimension of the cleaned data is \[822, 9\],
where 822 is the number of rows and 9 is the number of columns. The
“president” variable is created to contain democratic (dem) or
republican (gop) at any given time. The year range of this data set is
1947, 2015.
